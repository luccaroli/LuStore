DROP DATABASE IF EXISTS lustoredb;
CREATE DATABASE lustoredb;
...
-- auto upedated_at products 
CREATE TRIGGER set_timestamp
BEFORE UPDATE ON products
FOR EACH ROW
EXECUTE PROCEDURE trigger_set_timestamp(); 

-- auto upedated_at users 
CREATE TRIGGER set_timestamp
...
-- restart sequence auto_incremnet from tables ids
